    ...
    return (
        createPortal(
            <div className="pop-up-menu">
                <div className="pop-up-menu__cross" onClick={() => {setIsPopUp(false)}}>
                ...
                <div className="pop-up-menu-elements">
                    {elemMenu.map(el => {
                        //debugger
                        return <NavLink to={el.href} className="pop-up-menu-elements__elem">
                            <Icon icon={el.icon} background={el.background}/>
                            <p className='pop-up-menu-elements-elem__text'>{el.text}</p>
                        </NavLink>
                    })}
                </div>
                <div className="pop-up-menu-logout">
                    ...
                    <p className="pop-up-menu-logout__text">logout</p>
                </div>
